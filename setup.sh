...
downloadCovidReference(){
  ...
  wget "https://files.ca-1.osf.io/v1/resources/jt2n5/providers/osfstorage/5ede595708aad3013143c7f3?action=download&direct&version=3" -P .exampleData/covidReference
}
